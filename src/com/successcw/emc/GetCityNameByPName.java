...
@XmlRootElement(name = "GetCityNameByPName")
public class GetCityNameByPName {

    @XmlElementRef(name = "provinceName", namespace = "http://tempuri.org/", type = JAXBElement.class)
